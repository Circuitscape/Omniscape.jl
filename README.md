...
## Installation
Enter the following into a Julia terminal to install Omniscape.jl v0.1.0. If you would like to install the development version, simply remove `rev = "v0.1.0"` from the command below.
```julia
julia> using Pkg; Pkg.add(PackageSpec(url = "https://github.com/Circuitscape/Omniscape.jl", rev = "v0.1.0"))
