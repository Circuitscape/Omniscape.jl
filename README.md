...
## Installation
Enter the following into a Julia terminal to install Omniscape.jl v0.0.2. If you would like to install the development version, simply remove `rev = "v0.0.2"` from the command below.
```julia
